...
class DisplayCourseByCategories extends StatefulWidget {
  ...
  const DisplayCourseByCategories({Key key, this.name, this.imagesvg})
      : super(key: key);
  @override
  _DisplayCourseByCategoriesState createState() =>
      _DisplayCourseByCategoriesState();
}
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: SvgPicture.asset(widget.imagesvg,
              ...
              child: GraphQLProvider(
                ...
                child: Query(
                  options: QueryOptions(
                      documentNode:
                          gql(queryData.getCourseByCategories(widget.name))),
                            ...
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) =>
                                    PortfolioTutorialDetailPage(
                                      ...
                                      course_Title: repositories[index]
                                          ['title'],
                                    )));
                                  ...
                                  Container(
                                    child: ClipRRect(
                                      ...
                                      child: Image(
                                        ...
                                        image: isCheck
                                            ? SvgPicture.network(
                                                "${repositories[index]['feature_image']}")
                                            : NetworkImage(
                                                "${repositories[index]['feature_image']}"),
                                        // isCheck
